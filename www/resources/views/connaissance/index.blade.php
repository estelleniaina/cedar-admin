...
@section("content")
    ...
    <x-form.button-add funcAdd="addConnaissance()"></x-form.button-add>
...
@push("scripts")
    ...
    <script type="text/javascript">
        ...
        $(function () {
            let route = "{{ route('connaissance.index')  }}"
            let columns = [
                { data: 'id'},
                { data: 'titre'},
                { data: 'description'},
        ...
        function addConnaissance(){
            let sModalTitle = "Ajout base de connaissance"
        ...
        $('#'+sFormId).submit(function(e) {
            ...
            let route = "{{ route('connaissance.store') }}";
