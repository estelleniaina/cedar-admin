...
@section("content")
    ...
    <button type="button" class="btn btn-outline-success btn-sm" onclick="addHistoire()">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" id="HistoireForm" name="HistoireForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        @csrf
...
{{--                                <source src="{{asset('upload/histoires/1656053597-Facebook_2.mp4')}}" type="video/mp4">--}}
...
@push("scripts")
    ...
    <script type="text/javascript">
        ...
        function addHistoire(){
            let sModalTitle = "Ajout histoire";
